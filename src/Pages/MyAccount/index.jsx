...
function MyAccount() {
  ...
  return (
    <Layout>
      <h1 className="font-medium text-xl text-center mb-6 w-80"></h1>
      {view === "edit-user-info" ? (
        <form ref={form} className="flex flex-col gap-4 w-80">
          <div className="flex flex-col gap-1">
            ...
            <input
              ...
              placeholder="Harold"
              className="rounded-lg border-black placeholder:font-light placeholder:text-sm placeholder:text-black/60 focus:outline-none py-2 px-4"
            />
          </div>
          <div className="flex flex-col gap-1">
